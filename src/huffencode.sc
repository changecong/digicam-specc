/**************************************************
 * Author: Zhicong Chen -- 10/06/2012 14:03:39
 * Email: chen.zhico@husky.neu.edu
 * Filename: huffencode.c
 * Last modified: 10/06/2012 14:03:39
 * Description:
 * :set ts=4
 *************************************************/
...
behavior huffencode (in int in_block[64], i_sender out_port) {
