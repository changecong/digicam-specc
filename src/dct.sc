...
behavior ChenDCT(in int in_block[64], inout int out_block[64]){
  void main(void) {
    int i, aptr;
    int a0,  a1,  a2,  a3;
    int b0,  b1,  b2,  b3;
...
behavior DCT(in int in_block[64], out int out_block[64]){
  ...
  Preshift preshift(in_block, pre2chen); 
  ChenDCT chendct(pre2chen, chen2bound);
  Bound   bound(chen2bound, out_block);
